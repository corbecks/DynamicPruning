...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"piconet_epoch_{epoch+1}_weights.pt")

        torch.save(epoch_losses, "piconet_epoch_losses.pt")
        torch.save(epoch_accuracies, "piconet_epoch_accuracies.pt")
        torch.save(model.state_dict(), "piconet_final_weights.pt")
