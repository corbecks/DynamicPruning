    ...
    for inputs, labels, clusters in data_loader:
        ...
        if(cuttoff_increment==24):
            ...
            if(images_seen_increment%100 == 0):
                ...
                plt.colorbar()
                plt.title(f"Accuracy vs Cuttoffs w Femtonet({images_seen_increment} images per square)")
                plt.show()
                ...
                plt.xlabel("Mean Activation Cuttoff")
                plt.colorbar()
                plt.title(f"Filters Removed vs Cuttoffs w Femtonet ({images_seen_increment} images per square)")
                plt.show()
