...
class MicroNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 12, kernel_size=11, stride=4, padding=0),
            nn.BatchNorm2d(12),
            nn.ReLU(),
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"micronet_epoch_{epoch+1}_weights.pt")

        torch.save(epoch_losses, "micronet_epoch_losses.pt")
        torch.save(epoch_accuracies, "micronet_epoch_accuracies.pt")
        torch.save(model.state_dict(), "micronet_final_weights.pt")
