...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"nanonet_epoch_{epoch+1}_weights.pt")

        torch.save(epoch_losses, "nanonet_epoch_losses.pt")
        torch.save(epoch_accuracies, "nanonet_epoch_accuracies.pt")
        torch.save(model.state_dict(), "nanonet_final_weights.pt")
