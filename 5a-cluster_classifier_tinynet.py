...
class TinyNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 24, kernel_size=11, stride=4, padding=0),
            nn.BatchNorm2d(24),
            nn.ReLU(),
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"tinynet_epoch_{epoch+1}_weights.pt")

        torch.save(epoch_losses, "tinynet_epoch_losses.pt")
        torch.save(epoch_accuracies, "tinynet_epoch_accuracies.pt")
        torch.save(model.state_dict(), "tinynet_final_weights.pt")
